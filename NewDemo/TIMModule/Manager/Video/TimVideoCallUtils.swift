...
@objc class TimVideoCallUtils: NSObject {
    @objc public static let shared = TimVideoCallUtils()
    private override init() {}
    
    @objc public func data2CallModel(data: Data) -> VideoCallModel? {
        do {
    ...
    @objc public func callModel2Data(model: VideoCallModel) -> Data? {
        do {
