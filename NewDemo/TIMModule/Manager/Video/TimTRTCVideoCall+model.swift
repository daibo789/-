@objc enum VideoCallAction: Int32, Codable { //UserA 向 UserB 发起通话请求
    case error = -1             //用户错误
    case unknown = 0            //未知流程
    case dialing = 1            //请求发起
...
//model
@objc class VideoCallModel: NSObject, Codable {
    @objc var version: UInt32 = videoCallVersion                 //自定义消息 version
    @objc internal var calltype: VideoCallType = .unknown        //邀请类型 video or voice
    @objc var groupid: String? = nil                             //邀请群组
    @objc var callid: String = ""                                //通话ID，每次请求的唯一ID
    @objc var roomid: UInt32 = 0                                 //房间ID
    @objc var action: VideoCallAction = .unknown                 //信令消息
...
//    }
    ...
    enum CodingKeys: String, CodingKey {
           case version
           case calltype = "callIype"
           case groupid = "groupId"
           case callid = "callId"
           case roomid = "roomId"
           case action
           case invitedList = "invitedList"
       }
}
